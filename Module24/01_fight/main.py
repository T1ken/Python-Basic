...
# зачтено                                                                                                                (Воин1 изи победная +100 пр) с такими комментариями иди на хутор -1000 пр (Обидно что я живу в стране где бутылка водки стоит дороже чем 2 бутылки водки)
